...
a = Analysis(
    ...
    excludes=[
        ...
        'pywin32', 'pywin32-ctypes', 'PyYAML', 'pyzmq', 'referencing', 'requests-futures', 
        'rpds-py', 'schema', 'scikit-image', 'scikit-learn', 'scikit-metrics', 'scikit-plot', 
        'scipy', 'seaborn', 'setuptools', 'shapely', 'six', 'SQLAlchemy', 'stack-data', 
        'stem', 'sympy', 'threadpoolctl', 'tifffile', 'tinycss2', 'toolz', 'tornado', 
        'torrequest', 'traitlets', 'typing_extensions', 'tzdata', 'validators', 'wcwidth', 
